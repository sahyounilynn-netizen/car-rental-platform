...
export function AdminDashboardPage() {
  ...
  const updateShopStatusMutation =
    useMutation({
      mutationFn: async ({
        shopId,
        status,
  ...
  function confirmStatusChange(
    ...
    return window.confirm(
      `Are you sure you want to set ${label} to ${status}?`,
    );
  }
  ...
  function handleShopStatusChange(
    ...
    updateShopStatusMutation.mutate({
      shopId: shop.id,
      status,
    });
  }
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Search and manage customer and
            shop admin accounts.
          </CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Review tenant status, ownership,
            and activity counts.
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-4">
          ...
          {(updateUserStatusMutation.error ||
            updateShopStatusMutation.error) && (
            <Alert variant="destructive">
              {getApiMessage(
                updateUserStatusMutation.error ??
                  updateShopStatusMutation.error,
          ...
          ) : shopsQuery.data?.items
              .length ? (
            <div className="space-y-3">
              {shopsQuery.data.items.map(
                (shop) => (
                  <div
                    key={shop.id}
                    className="rounded-xl border border-border p-4"
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Review sensitive actions performed
            across the platform.
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-4">
          <div className="grid gap-3 md:grid-cols-3">
            ...
            >
              ...
              <option value="SHOP_STATUS_UPDATED">
                Shop status updated
              </option>
              <option value="CAR_CREATED">
                Car created
              </option>
              <option value="CAR_UPDATED">
                Car updated
              </option>
              <option value="CAR_ARCHIVED">
                Car archived
              </option>
              <option value="BOOKING_STATUS_UPDATED">
      ...
      <div className="flex items-start gap-3 rounded-xl border border-border bg-accent/30 p-4 text-sm text-muted-foreground">
        ...
        Suspended shops are removed from
        normal car discovery and online
        booking availability because public
        car queries filter to active shops.
      </div>
    </div>
  );
}